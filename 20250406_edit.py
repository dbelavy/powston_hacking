...
night_fill = 20 # SOC below which we import at night if the price is below buy_max_soft
...
elif (hour in night) and buy_price < buy_max_soft and battery_soc < night_fill:
    action = 'import'
    solar = 'maximize'
    reason += f' Nighttime low price and battery < {night_fill}%. Importing.'
elif (hour in night) and buy_price < buy_max_soft:
    action = 'charge'
    solar = 'maximize'
    reason += ' Nighttime charge below soft max buy price.'
